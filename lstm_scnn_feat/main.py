...
if args.model_type=='teacher': model = Leglaive_RNN(timesteps=CNN_INPUT_SIZE)
elif args.model_type=='student': model = RNN_small(timesteps=CNN_INPUT_SIZE)
else:
...
save_path = './results/'+args.model_type+'/'
...
shutil.move(wts_dir+best_model_name, './'+best_model_name)
