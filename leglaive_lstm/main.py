...
best_model_name = 'val_acc-'+'{0:.4f}_'.format(best_val_acc)+args.model_type+'_tr_acc-'+'{0:.4f}'.format(tr_acc)+'_bestEp-'+str(idx+1)+\
...
suffix = 'test_acc-'+'{0:.4f}_'.format(df_save['test_acc'])+best_model_name[:-3]
